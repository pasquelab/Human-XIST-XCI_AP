...
Each group of data was analysed separately in different folder. Fastq files were placed in a `fastq/raw/` subfolder on a cluster and processed using the provided snakemake workflows and simple bash script. The Snakemake workflows are composed of 4 files:
