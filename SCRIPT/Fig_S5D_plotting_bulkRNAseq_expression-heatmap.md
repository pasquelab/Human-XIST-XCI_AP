...
Reads were pseudo-aligned using kallisto/0.46.2 [(Bray et al., 2016)](https://github.com/pachterlab/kallisto) to quantify transcripts abundancein TPM (Transcripts Per Kilobase Million).
